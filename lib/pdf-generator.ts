...
export async function generatePDF(
  ...
  const addPageNumber = (pageNum: number) => {
    ...
    const footerText = `Page ${pageNum} | Document Number: ${docNumber} | Generated by LastWishCrypto.eth on ${currentDate}`
  ...
  pages.forEach((p, index) => {
    ...
    const footerText = `Page ${pageNum} of ${totalPages} | Document Number: ${docNumber} | Generated by LastWishCrypto.eth on ${currentDate}`
